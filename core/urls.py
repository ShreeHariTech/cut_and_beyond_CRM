...
urlpatterns = [
    ...
    path('today-bills/', today_bills, name='today_bills'),

    # Super Admin — Branch & User Management
    path('manage-branches/', manage_branches, name='manage_branches'),
    path('manage-users/', manage_users, name='manage_users'),

    # Legacy Admin CRUD (still works, now also protected by @super_admin_required)
